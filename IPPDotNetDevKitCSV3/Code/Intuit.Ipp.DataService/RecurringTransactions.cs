...
namespace Intuit.Ipp.DataService
{
    ...
    public class RecurringTransactions
    {
        ...
        /// batch requests
        /// </summary>
        private List<RecurringTransaction> recurringTxnRequests;
        ...
        public int Count
        {
            get
            {
                return this.recurringTxnRequests.Count;
            }
        }
        ...
        /// </summary>
        public ReadOnlyCollection<RecurringTransaction> IntuitRecurringTransactionResponse
        {
            get { return new ReadOnlyCollection<RecurringTransaction>(this.intuitBatchItemResponse); }
        }
        ...
        #region methods
        public enum RecurrTransactionChoiceType
        {
            Invoice,
            Bill
        }
