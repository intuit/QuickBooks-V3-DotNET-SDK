...
{   /// <summary>
    ...
    public class OAuth2Client
    {
        ...
        public string GetAuthorizationURL(List<string> scopes, string CSRFToken)
        {
            ...
            {
                throw new Exception("Discovery Call failed. Authorize Endpoint is empty.");
            }
